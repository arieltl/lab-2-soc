...
module niosLab2_mm_interconnect_0 (
	...
	wire  [93:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> pio_0_s1_agent:cp_data
	...
	wire  [17:0] onchip_memory_0_s1_agent_m0_address;                                                // onchip_memory_0_s1_agent:m0_address -> onchip_memory_0_s1_translator:uav_address
	...
	wire  [94:0] onchip_memory_0_s1_agent_rf_source_data;                                            // onchip_memory_0_s1_agent:rf_source_data -> onchip_memory_0_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] onchip_memory_0_s1_agent_rsp_fifo_out_data;                                         // onchip_memory_0_s1_agent_rsp_fifo:out_data -> onchip_memory_0_s1_agent:rf_sink_data
	...
	wire  [93:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> onchip_memory_0_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // onchip_memory_0_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [4:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> onchip_memory_0_s1_agent:cp_channel
	...
	wire  [93:0] pio_0_s1_agent_rp_data;                                                             // pio_0_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [93:0] onchip_memory_0_s1_agent_rp_data;                                                   // onchip_memory_0_s1_agent:rp_data -> router_005:sink_data
	...
	niosLab2_mm_interconnect_0_router_003 router_006 (
	...
	niosLab2_mm_interconnect_0_cmd_mux_001 cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                      //       clk.clk
		.reset               (onchip_memory_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosLab2_mm_interconnect_0_rsp_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosLab2_mm_interconnect_0_rsp_demux_001 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                      //       clk.clk
		.reset              (onchip_memory_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosLab2_mm_interconnect_0_rsp_demux_001 rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                      //       clk.clk
		.reset              (onchip_memory_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
